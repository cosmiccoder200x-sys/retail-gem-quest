...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Frequently asked questions about orders, payments, shipping and returns at ${siteConfig.name}.`,
      },
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-2 text-muted-foreground">
        Search answers or browse by category. Content is in <code>src/lib/faq.ts</code> — edit
        there.
      </p>
      ...
      <div className="mt-8 space-y-3">
        {filtered.map((f) => (
          <details
            key={f.q}
            className="group rounded-2xl bg-white p-4 ring-1 ring-border open:ring-brand/20"
          >
