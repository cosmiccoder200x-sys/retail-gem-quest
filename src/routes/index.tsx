    ...
    <div>
        ...
        <div className="grid items-center gap-8 p-4 sm:p-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-2">
          <div>
            ...
            <p className="mt-3 max-w-sm text-base text-muted-foreground sm:text-lg">
              Trending kitchen tech, home comfort and cleaning gadgets — quality tested, shipped
              fast, Cash on Delivery available.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Button
                asChild
                size="lg"
                className="rounded-full bg-brand px-7 font-semibold hover:bg-brand/90"
              >
                <Link to="/products">
      ...
      {categories && categories.length > 0 && (
        <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
          <SectionHeader title="Browse Categories" subtitle="Explore gadgets by type" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <SectionHeader title="Featured this week" subtitle="Hand-picked trending gadgets" />
        <ProductGrid
          products={featured}
          loading={false}
          error={false}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <SectionHeader title="Bestsellers" subtitle="Most loved by thousands of homes" />
        <ProductGrid
        ...
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-1 lg:grid-cols-2">
          <div className="rounded-2xl bg-card p-6 ring-1 ring-border">
            ...
            <p className="text-sm text-muted-foreground">
              On all home comfort gadgets. Use code COMBO10 at checkout.
            </p>
          </div>
          <div className="rounded-2xl bg-card p-6 ring-1 ring-border">
            <h3 className="font-display text-xl font-bold tracking-tight mb-3">Bank Offer</h3>
            <p className="text-sm text-muted-foreground">
              Up to ₹200 instant discount on orders above ₹999. T&C apply.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <SectionHeader title="Why GullyGadget" subtitle="Trusted by thousands of Indian homes" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <SectionHeader title="Customer Reviews" subtitle="What Indian homes say about us" />
        <div className="rounded-3xl bg-card p-6 ring-1 ring-border">
          ...
          <p className="mt-3 text-center text-sm text-muted-foreground">
            Example ratings from catalog — see product pages for real reviews
          </p>
        </div>
      </section>
