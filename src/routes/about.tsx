...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Learn about ${siteConfig.name} — curated home and lifestyle gadgets, quality tested, affordable, shipped across India.`,
      },
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="mt-8 space-y-6 leading-relaxed">
        <p>
          <strong>{siteConfig.name}</strong> is a curated store for trending home and lifestyle
          gadgets — mini coolers, kitchen tech, smart lighting, and everyday helpers. We keep prices
          accessible and quality verifiable.
        </p>
        ...
        <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
          ...
          <li>
            Policies on this site reflect our current operations — see Shipping, Returns, Privacy,
            and Terms.
          </li>
        </ul>
        <div className="rounded-2xl bg-brand-soft p-4 ring-1 ring-border">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {siteConfig.address} · Email: {siteConfig.email} · Phone: {siteConfig.phone}
          </p>
          <p className="text-xs text-muted-foreground mt-1">
            Update <code>src/lib/site.ts</code> for your registered name and contacts.
          </p>
        </div>
        <p>
